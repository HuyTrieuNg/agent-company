"""Registry for news sources and categories."""
...
_DEFAULT_CATEGORIES_FILE = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "categories.json"
)
...
class SourcesRegistry:
    """Registry managing available news sources, categories, and alias normalization."""

    def __init__(self, json_path: str = _DEFAULT_CATEGORIES_FILE) -> None:
